...
function sendLink() {
    ...
    const fixedNumber = document.getElementById('fixed-whatsapp-link').dataset.fixedNumber || "+201103189070"; // Default to Yasser's number
...
function updateFixedNumber() {
    ...
    if (selectedNumber) {
        ...
        document.getElementById('fixed-whatsapp-link').dataset.fixedNumber = "+201103189070"; // Default number
    }
}
